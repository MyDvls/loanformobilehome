...
export default function Team({ teamSection, teamMembers }: Props) {
    ...
    return (
        <LandingLayout>
            <Head title={teamSection?.heading || t('team.title')} />
            ...
            <section className="relative mt-10 overflow-visible py-20">
                <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-12 xl:px-24">
                    <AnimateOnView delay={0.2}>
                        <h2 className="mb-2 text-center text-4xl font-bold text-gray-800 dark:text-white">
                            {teamSection?.heading || t('team.title')}
                        </h2>
                        <p className="mb-12 text-center text-xl text-gray-600 dark:text-gray-300">{teamSection?.sub_heading || t('team.subtitle')}</p>
                    </AnimateOnView>
                    ...
                    {teamMembers.length > 0 ? (
                            ...
                            {teamMembers.map((member, index) => (
                                <AnimateOnView key={member.id} delay={0.3 + index * 0.1}>
                                    ...
                                    >
                                            ...
                                            <img
                                                ...
                                                src={
                                                    ...
                                                    'https://ui-avatars.com/api/?name=' +
                                                        ...
                                                        '&size=128&background=8B5CF6&color=fff'
                                                }
                                                alt={member.name}
                                        ...
                                        <p className="mb-4 line-clamp-3 text-gray-600 dark:text-gray-300">{member.bio.substring(0, 150)}...</p>
                                        <button
                        ...
                        <p className="text-center text-gray-600 dark:text-gray-300">No team members available.</p>
                    )}
                </div>
            </section>
                                        ...
                                        <div key={member.id} className="flex flex-col md:flex-row">
                                            ...
                                            <div className="p-8 md:w-2/3">
                                                ...
                                                <div className="max-h-[60vh] overflow-y-scroll pr-2">
                                                    <p className="max-h-[45vh] whitespace-pre-line text-gray-600 dark:text-gray-300">{member.bio}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
